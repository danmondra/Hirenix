import { interviewReviewPromptGenerator } from '@/helpers/promptGenerators'
...
export async function POST(req) {
  ...
  const [systemPrompt, userPrompt, responseExample] = interviewReviewPromptGenerator(interview)
